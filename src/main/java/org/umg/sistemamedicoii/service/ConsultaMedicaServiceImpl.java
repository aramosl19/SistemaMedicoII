...
import org.umg.sistemamedicoii.repository.ConsultaMedicaRepository;
...
public class ConsultaMedicaServiceImpl implements ConsultaMedicaService {
    ...
    private void validarCierre(ConsultaMedicaRequestDTO dto) {
        ...
        if (diagnostico == null || diagnostico.length() < DIAGNOSTICO_MIN || diagnostico.length() > DIAGNOSTICO_MAX) {
            throw new IllegalArgumentException(
