...
import org.umg.sistemamedicoii.repository.atencion_medica_enfermeria.SignosVitalesRepository;
...
public class SignosVitalesServiceImpl implements SignosVitalesService {
    ...
    private SignosVitalesResponseDTO toResponseDTO(SignosVitales signos, boolean emergencia) {
        ...
        if (emergencia) {
            ...
            respuesta.setMensaje("Signos vitales del paciente " + nombrePaciente + " registrados correctamente. El paciente puede regresar a la sala de espera.");
        }
        return respuesta;
    }
}